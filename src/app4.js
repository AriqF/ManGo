...
function setAvailableQuestion(){
    ...
    const totalQuestion = quiz4.length;
    for(let i=0; i<totalQuestion; i++){
        availableQuestion.push(quiz4[i])
    }
...
function getNewQuestion(){
    ...
    //set question text
    questionNumber.innerHTML = "Question " + (questionCounter + 1) + " of " + quiz4.length;
    //get random question
...
function next(){
    ...
    if(questionCounter === quiz4.length){
...
function quizResult(){
    ...
    const percentage = (correctAnswer/quiz4.length) * 100;

    resultBox.querySelector(".total-question").innerHTML = quiz4.length;
    ...
    resultBox.querySelector(".total-score").innerHTML = correctAnswer + "/" + quiz4.length;
...
window.onload = function(){
    ...
    homeBox.querySelector(".total-question").innerHTML = quiz4.length;
}
...
let attempt = 0; //total answerd question by user
let correctAnswer = 0;
...
function getNewQuestion(){
    ...
    //console.log(index1) --> question number when inputed in quiz 
    ...
    //console.log(availableOptions); --> show length of available options
    //console.log(quesitonIndex);
    //console.log(availableQuestion);
    //console.log(currentQuestion.options); --> question options
    questionCounter++;
}
...
function getResult(element){
    ...
    //make the option is int so that can compare to the currentQuestion.answer
    ...
    if(id === currentQuestion.answer){
        ...
        //add green indicator for correct answer
        ...
        //add red indicator for wrong answer
        updateAnswerIndicator("wrong");

        //showing user the correct answer
    ...
    attempt++;
    //make the user can't click once the user already choose one
    optionUnclickable();
}
...
function start(){
    ...
    quizBox.classList.remove("hide");
    //set all question in setAvailable then call it getNew

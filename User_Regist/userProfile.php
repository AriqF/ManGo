        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgba(17,17,17,0.75); box-shadow: 0 3px 7px 0 rgba(0,0,0,0.35); font-family: 'Poppins', sans-serif; font-size: 18px;">
            ...
            <form>
                <div class="form-group row">
                    ...
                    <input type="text" readonly class="form-control-plaintext" value="<?php echo $_SESSION['email']; ?> " style="color: white; font-size: 18px">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Username</label>
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" value="<?php echo $_SESSION['username']; ?>" style="color: white; font-size: 18px">
                    </div>
                </div>
                <p>
                    Untuk mengganti password anda, silahkan klik tombol dibawah ⬇️
                </p>
